// taken from Sway's docs: https://fuellabs.github.io/sway/latest/examples/subcurrency.html
...
impl Token for Contract {
    fn balanceOf(account: Address) -> u64 {
        let storage_slot = hash_pair(STORAGE_BALANCES, account.into(), HashMethod::Sha256);
        let account_balance = get::<u64>(storage_slot);
